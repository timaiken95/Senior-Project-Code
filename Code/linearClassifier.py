...
def createLinearSVMs():
    trainSVMLinear(flatBad, flatOK, flatSVMlinear)
    trainSVMLinear(eyesBad, eyesOK, eyesSVMlinear)
    trainSVMLinear(darkBad, darkOK, darkSVMlinear)
    trainSVMLinear(contrastBad, contrastOK, contrastSVMlinear)
    trainSVMLinear(qualityBad, qualityOK, qualitySVMlinear)


def trainSVMLinear(badfile, okfile, saveLocation):
